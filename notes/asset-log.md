...
| Review v2 | 828.6 kB initial (227.4 kB gzip) | 13.4 kB (4.1 kB gzip) | 0 B | Layered content, 30 focus stories, and auto-framing; GLB loader remains split (43.0 kB gzip), complete `dist/` is 5.8 MB |
